 ...
 * Use the [GenrePageFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class GenrePageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GenrePageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                GenrePageFragment().apply {
